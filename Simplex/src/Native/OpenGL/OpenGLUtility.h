...
inline GLenum ChannelsToFormatGL(int channels)
{
	switch (channels)
	{
...
inline GLenum SXGFilterToGL(SXG::TexFilter filter, SXG::TexMipmapMode mipmap)
{
	using namespace SXG;
...
inline GLenum SXGWrapModeToGL(SXG::TexWrapMode wrap)
{
	using namespace SXG;
